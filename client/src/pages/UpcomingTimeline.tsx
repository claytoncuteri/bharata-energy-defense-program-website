    ...
    <div className="min-h-screen py-10 md:py-16 bg-background">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-12 bg-gradient-to-r from-primary/10 via-chart-2/10 to-chart-1/10 rounded-lg p-6">
            <h2 className="text-2xl font-serif font-semibold mb-3" data-testid="text-budget-title">
              Budget Requirement
            </h2>
